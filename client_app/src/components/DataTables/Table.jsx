  ...
  return (
    <span
      className={classNames(
        ...
        status.startsWith('for_approval') ? 'bg-yellow-100 text-yellow-800' : null,
        status.startsWith('paid') ? 'bg-green-100 text-green-800' : null,
        status.startsWith('processing') ? 'bg-green-100 text-green-800' : null,
        status.startsWith('delivered') ? 'bg-blue-100 text-blue-800' : null,
