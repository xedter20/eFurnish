...
const AccountSettings = () => {
  ...
  return (
    <section className="px-[4%] md:px-[7%]">
      <Helmet>
        <title>My Account - EFurnish</title>
      </Helmet>
      <h1 className="pt-6 text-2xl font-medium">Account Settings</h1>
      <div className="mb-5 mt-10 flex w-full">
        <p
          onClick={() => setActiveTab("profile")}
          className={`flex w-1/2 cursor-pointer items-center justify-center gap-1.5 border-b-2 pb-2 text-center font-semibold transition-all ${activeTab === "profile"
