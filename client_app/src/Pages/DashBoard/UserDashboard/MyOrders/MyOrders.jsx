...
const MyOrders = () => {
  ...
  return (
    <section className="mb-28 px-[4%] md:px-[7%]">
      <Helmet>
        <title>My Orders - EFurnish</title>
      </Helmet>
                ...
                <Link
                  ...
                  {order.items.map((item, index) => (
                    ...
                    >
                      ...
                      <p className="hidden w-14  pt-1 text-sm text-gray-400 md:block">
                        Color: {item.color}
                        <div
                          style={{
                            width: '50px',
                      ...
                      <p
                        className={`h-fit w-24  rounded-full p-1 text-center text-xs capitalize ${order.status === "pending"
