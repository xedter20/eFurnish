                ...
                orders.map((order) => (
                  <React.Fragment key={order._id}>
                    <tr key={order._id} className="hover">
                      ...
                      <td>
                        <p
                          className={`w-20 rounded p-1 text-center text-xs capitalize ${order.status === "pending"
                      ...
                      <td>
                        <select
                          className={`cursor-pointer rounded border border-gray-300 px-2 py-1 text-gray-800 ${order.status === "cancelled" &&
